...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(sender: AnyObject) {
        ...
        let vc: UINavigationController = storyboard.instantiateViewControllerWithIdentifier("AddViewController") as! UINavigationController
        self.presentViewController(vc, animated: true, completion: nil)
        
        //let addItemViewController: AddItemViewController = AddItemViewController()
